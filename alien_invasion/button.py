...
class Button:
    def __init__(self, ai_game, msg):
        ...
        self.rect = pygame.Rect(0, 0, self.width, self.height)  # создаем объект rect для кнопки
        self.rect.center = self.screen_rect.center  # выравниваем объект rect по центру экрана
